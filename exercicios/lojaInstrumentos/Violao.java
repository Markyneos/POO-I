public class Violao extends Instrumento implements InstrumentoAcustico, InstrumentoCorda {

	private int numeroDeCordas = 6;
	private String afinacao = "Padrão";

	public Violao(String modelo, double preco) {
		super(modelo, preco);
	}
	...
	public void afinar(String afinacao) {
		switch (afinacao) {
			case "Padrão":
				...
				System.out.println(listaAfinações[0]);
				break;
			case "Drop D":
				this.afinacao = afinacao;
				System.out.println(listaAfinações[1]);
				break;
			case "Drop C":
				this.afinacao = afinacao;
				System.out.println(listaAfinações[2]);
				break;
			case "Drop B":
				this.afinacao = afinacao;
				System.out.println(listaAfinações[3]);
				break;
			default:
