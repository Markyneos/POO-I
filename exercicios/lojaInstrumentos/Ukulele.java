public class Ukulele extends Instrumento implements InstrumentoCorda, InstrumentoAcustico {

	private int numeroDeCordas = 4;
	private String afinacao = "Padrão";

	public Ukulele(String modelo, double preco) {
		super(modelo, preco);
	}
